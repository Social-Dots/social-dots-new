# Generated by Django 4.2.7 on 2025-06-19 20:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(blank=True, help_text='Project image path', max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.CharField(blank=True, help_text='Service image path', max_length=200, null=True)),
                ('price', models.DecimalField(blank=True, decimal_places=2, help_text='Price in CAD', max_digits=10, null=True, validators=[django.core.validators.MinValueValidator(Decimal('0.01'))])),
                ('price_type', models.CharField(choices=[('fixed', 'Fixed Price'), ('hourly', 'Per Hour'), ('monthly', 'Per Month'), ('custom', 'Custom Quote')], default='custom', max_length=20)),
